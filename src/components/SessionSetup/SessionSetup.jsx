...
const TEAMS_DISPLAY = [
  { id: 'LV',  espnId: 'lv',  abbreviation: 'LV',  city: 'Las Vegas',      nickname: 'Raiders',    colors: { primary: '#000000', secondary: '#A5ACAF' }, conf: 'AFC', div: 'West',  r1pick: 1  },
  ...
  { id: 'NYG', espnId: 'nyg', abbreviation: 'NYG', city: 'New York',       nickname: 'Giants',     colors: { primary: '#0B2265', secondary: '#A71930' }, conf: 'NFC', div: 'East',  r1pick: 5  },
  ...
  { id: 'BAL', espnId: 'bal', abbreviation: 'BAL', city: 'Baltimore',      nickname: 'Ravens',     colors: { primary: '#241773', secondary: '#9E7C0C' }, conf: 'AFC', div: 'North', r1pick: 14 },
  ...
  { id: 'CHI', espnId: 'chi', abbreviation: 'CHI', city: 'Chicago',        nickname: 'Bears',      colors: { primary: '#0B162A', secondary: '#C83803' }, conf: 'NFC', div: 'North', r1pick: 25 },
  ...
  { id: 'HOU', espnId: 'hou', abbreviation: 'HOU', city: 'Houston',        nickname: 'Texans',     colors: { primary: '#03202F', secondary: '#A71930' }, conf: 'AFC', div: 'South', r1pick: 28 },
  { id: 'NE',  espnId: 'ne',  abbreviation: 'NE',  city: 'New England',    nickname: 'Patriots',   colors: { primary: '#002244', secondary: '#C60C30' }, conf: 'AFC', div: 'East',  r1pick: 31 },
  { id: 'SEA', espnId: 'sea', abbreviation: 'SEA', city: 'Seattle',        nickname: 'Seahawks',   colors: { primary: '#002244', secondary: '#69BE28' }, conf: 'NFC', div: 'West',  r1pick: 32 },
